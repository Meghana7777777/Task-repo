...
@Controller('meeting-room-controller')
export class MeetingRoomController {
    constructor(
        private service: MettingRoomService,
        private readonly applicationExceptionHandler: ApplicationExceptionHandler
    ) {}

    @Post('/createMeetingRoom')
    @ApiBody({ type: MettingRoomDto })
    async createMeetingRoom(@Body() req: MettingRoomDto): Promise<CommonResponseModel> {
    ...
    @ApiBody({ type: MettingRoomDto })
    async updateMeetingRoom(@Body() req: MettingRoomDto): Promise<CommonResponseModel> {
        try {
    ...
    @ApiBody({ type: MettingRoomDto })
    async activateOrDeactivateMeetingRoom(@Body() dto: MettingRoomDto): Promise<CommonResponseModel> {
        try {
