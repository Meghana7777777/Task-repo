...
export interface EmployeeJoiningPdfProps {
    rec: any
}

const EmployeeJoiningPdf = (props: EmployeeJoiningPdfProps) => {
    ...
    const marialStatusData = () => {
        if (data?.maritualStatus === "M") {
            return <>Married</>
        }
        else if (data?.maritualStatus === "U") {
            return <>Unmarried</>
        }
        else if (data?.maritualStatus === "O") {
            return <>Others</>
        }
        else {
            return <>&nbsp;</>
    ...
    return (
        <>
            ...
            <Card>
                ...
                <div style={{ maxWidth: 600, margin: "0 auto", fontFamily: "Arial, sans-serif" }} className="record-container" id='printJoiningFormSection1'>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style={{ borderLeft: "1px solid black", borderRight: "1px solid black", fontSize: "15px", fontWeight: "bold", padding: "6px" }}>
                                            <b>Pan Card No :</b>{" "}<span style={{ fontSize: "15px", fontWeight: 400 }}>{data.employeeIdProofs[0]?.idNumber}</span>
                                        </td>
                                        <td style={{ borderLeft: "1px solid black", borderRight: "1px solid black", fontSize: "15px", fontWeight: "bold", padding: "6px" }}>
...
export default EmployeeJoiningPdf;