...
import EmployeeExitDocumentDataPdf from "./employee-excit-document-pdf";
import { PageContainer } from "@ant-design/pro-layout";



const EmployeeExitDocumentData = () => {
    const { Option } = Select
    ...
    const handlePrint = useReactToPrint({
        contentRef: printRef,
        documentTitle: 'Employee Exit Document',
    ...
    return (
        <>
            <PageContainer title="Employee Exit Document" >
...
export default EmployeeExitDocumentData;