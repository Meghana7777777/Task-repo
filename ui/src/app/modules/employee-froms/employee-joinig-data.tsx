...
import EmployeeJoiningPdf from "./statutory-handovers/employee-joining-pdf";
...
`;
    ...
    return (
        <>
            <PageContainer title="Employee Joining Form" >
                <Form form={form} layout="vertical" onFinish={getEmployeeData}>
                    <Row gutter={24}>
                        <Col xs={24} sm={12} md={8} lg={4} xl={4}>
                            ...
                            >
                                <Select placeholder="Select Branch" showSearch allowClear optionFilterProp="children" onChange={(value) => getAllActiveEmployees(value)}>
...
export default EmployeeJoiningData;