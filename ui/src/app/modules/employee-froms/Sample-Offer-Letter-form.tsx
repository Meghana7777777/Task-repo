...
import { AlertMessages, BranchReq, EmployeeDetailsDto, PayrollProcessedLogReq } from "@hrexpert/shared-models";
import { BranchesService, DepartmentService, DesignationsService, EmployeeOnboardingService, EmployeeTypeService, PayrollRecordsSharedService } from "@hrexpert/shared-services";
import { Button, Card, Checkbox, Col, Form, Input, message, Modal, Row, Select, Space, Table, Tag } from "antd";
import { ColumnProps, ColumnType } from "antd/es/table";
import { useEffect, useRef, useState } from "react";
import { useReactToPrint } from "react-to-print";
import SampleOfferLetterPdf from './Sample-Offer-Letter-pdf'
import { useIAMClientState } from "../../common/iam-client-react";
import Highlighter from "react-highlight-words";
import { PageContainer } from "@ant-design/pro-layout";

const SampleOfferLetterForm = () => {
    const { Option } = Select
...
`;
    ...
    const handlePrint = useReactToPrint({
        contentRef: printRef,
        documentTitle: 'Employee Join form',
    ...
    return (
        <>
            <PageContainer title="Employee Offer Letter" >
                ...
                >
                    <div ref={printRef}>
                        {selectedRows.length === 1 ? (
                            <SampleOfferLetterPdf
                                rec={selectedRows[0]}
                                payroll={allPayrollEmployees}
                            />
                        ) : (
                            <div
                                style={{
...
export default SampleOfferLetterForm;