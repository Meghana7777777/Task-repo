...
export const LeaveApplyApprovalGridByRm = (props: LeavesApprovalGridIProps) => {
    const { scopes } = props
    const { TabPane } = Tabs;
    const { Option } = Select
    ...
    const getAppliedForLeavesApproved = () => {
        ...
        if (formValues.branchName) req.branchId = formValues.branchName;
        if (formValues.employeeName) req.employeeId = formValues.employeeName;
        req.reportingManager = formValues.employeeName;
        try {
...
export default LeaveApplyApprovalGridByRm;