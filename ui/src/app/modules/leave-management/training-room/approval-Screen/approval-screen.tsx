    ...
    return (
        <PageContainer title="Training Approval">
            ...
            >
                ...
                <Tabs.TabPane tab="Approved" key={ScheduleStatus.APPROVED}>
                    <Table
                        columns={columns}
                ...
                <Tabs.TabPane tab="Rejected" key={ScheduleStatus.CANCELED}>
                    <Table
                        columns={columns}
