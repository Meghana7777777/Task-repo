...
const TrainingSchedule = (props: MeetingRoomScheduleProps) => {
    ...
    let getRoomsData = props.getData
    useEffect(() => {
        if (selectedDate) {
    ...
    const onFinish = async (values: any) => {
        ...
        let roomApprover;
        if (mappedRoomId != undefined) {
            roomApprover = mappedRoomId.room.roomApprover
        }
