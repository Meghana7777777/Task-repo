...
import MeetingRoomMaster from './meetingRoomMaster';

interface MeetingRoomGridIProps { }

const MeetingRoomGrid = (props: MeetingRoomGridIProps) => {
    ...
    return (
        <>
            ...
            <Modal
                ...
                title={isUpdate ? 'Update Meeting Room' : 'Create Meeting Room'}
                open={modalVisible}
                onCancel={closeModal}
                footer={null}
                width="60%"
