...
import { MettingRoomService, UsersService } from '@hrexpert/shared-services';
...
export default function MeetingRoomMaster(props: MeetingRoomMasterProps) {
                ...
                <Row gutter={[24, 24]}>
                    ...
                    <Col xs={24} sm={12} md={8} lg={6} xl={6}>
                        <Form.Item
                            ...
                            name="capacity"
                            rules={[
                                { required: true, message: 'Enter Meeting Room capacity' },
                                {
                                    validator: (_, value) => {
