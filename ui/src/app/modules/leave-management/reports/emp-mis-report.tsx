...
export default function EmployeeMisReport() {
    ...
    function getReportData() {
        ...
        empService.getBranchEmployeeWiseMisReport(req).then((res) => {
            if (res.status) {
                setData(res.data)
            } else {
                setData([])
    ...
    const exportToExcel = async () => {
        const fileName = `Employee-mis-Report.xlsx`;
        const workbook = new ExcelJS.Workbook();
        const worksheet = workbook.addWorksheet("Employee Report");
    
        // Define parent headers
        const parentHeaders = [ "S No", "Branch Name", "State", "Employees", "Gender", "", "Age", "", "", "", "", "Employee Tenure", "", "", "", "Leave Policy Code", "Salary Policy Code"
        ];
    ...
    return (
        <>
            <Card title='Employee MIS Report'
                extra={<span><Button
