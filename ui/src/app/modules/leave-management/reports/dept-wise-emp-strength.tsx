...
export default function DeptWiseEmpStrengthReport() {
    ...
    useEffect(() => {
        getDeptWiseEmpStrengthForHr();
    }, []);

    function getDeptWiseEmpStrengthForHr() {
        empService.getDeptWiseEmpStrengthForHr().then((res) => {
    ...
    function exportToExcel() {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "DeptWiseEmpStrength");
        ...
        saveAs(dataBlob, "DeptWiseEmpStrengthReport.xlsx");
    }

    return (
        <>
            <Card
                title="Department Wise Employee Strength Report"
                extra={
                    <Button
