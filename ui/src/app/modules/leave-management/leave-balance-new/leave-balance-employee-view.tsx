...
const LeaveBalanceEmployeeView = (props: LeaveAllocationViewProps) => {
    const { scopes } = props;
    ...
    const getEmpData = async () => {
        try {
            ...
            const req = new EmpDataReq(formValues.employeeId, null, null, dayjs(formValues.monthYear).format('YYYYMM'), null,
                formValues.branchId === 'ALL' ? null : formValues.branchId, null, 1,
            );
    ...
    const exportToExcel = () => {
        ...
        excel
            .addSheet('Employee Leave Balance Report')
    ...
    return (<>
        <PageContainer title={'Employees Leave Balance'} >
...
export default LeaveBalanceEmployeeView;