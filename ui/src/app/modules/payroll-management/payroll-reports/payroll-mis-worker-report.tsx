...
interface PayrollMisReportWorkerProps {
    scopes: ScopesEnum[]
}


const PayrollMisWorkerReport = (props: PayrollMisReportWorkerProps) => {
    ...
    const getPayrollMisReportWorker = () => {
        ...
        try {
            service.getPayrollMisReportWorker(req).then((res) => {
                if (res.status) {
    ...
    return (
        <PageContainer title='Payroll Worker Audit Report' breadcrumbRender={false}>
            <Form form={form} layout="vertical">
                <Row gutter={[16, 8]}>
                    ...
                    <Col>
                        <Button onClick={getPayrollMisReportWorker} style={{ marginTop: "23px" }} type="primary" variant="outlined" color="primary">Submit</Button>
                    </Col>
                    <Col>
...
export default PayrollMisWorkerReport;