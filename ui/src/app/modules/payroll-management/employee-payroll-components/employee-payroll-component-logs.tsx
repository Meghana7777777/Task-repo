...
import { BranchReq, EmpDataReq, PayrollProcessedLogReq } from '@hrexpert/shared-models';
import { BranchesService, DepartmentService, DesignationsService, DivisionService, EmployeeOnboardingService, EmployeeTypeService, LeaveAllocationService, PayrollComponentsSharedService, PayrollRecordsSharedService } from '@hrexpert/shared-services';
...
const EmployeePayrollComponentLogs = () => {
    ...
    return (
        <div>
            <Card title={<span>Employee Salary Breakdown Logs</span>}>
...
export default EmployeePayrollComponentLogs;
